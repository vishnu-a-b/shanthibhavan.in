...
| Backend API | https://api.shanthibhavan.in |
...
BACKEND_URL=https://api.shanthibhavan.in
...
NEXT_PUBLIC_BACKEND_IMAGE_URL=https://api.shanthibhavan.in
```
...
| Backend | Node.js server (https://api.shanthibhavan.in) |
