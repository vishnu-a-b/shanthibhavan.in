...
"[project]/Official/SbWebsite/models/Banner.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Official/SbWebsite/app/api/banner/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Official$2f$SbWebsite$2f$models$2f$Banner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Official/SbWebsite/models/Banner.ts [app-route] (ecmascript)");
;
;
;
async function GET() {
    try {
        ...
        const banners = await __TURBOPACK__imported__module__$5b$project$5d2f$Official$2f$SbWebsite$2f$models$2f$Banner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            isActive: true
        }).sort({
            order: 1
        }).lean();
...
async function POST(request) {
    try {
        ...
        const newBanner = await __TURBOPACK__imported__module__$5b$project$5d2f$Official$2f$SbWebsite$2f$models$2f$Banner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            title,
            description,
            imageUrl,
            order: order || 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__190b1d85._.js.map