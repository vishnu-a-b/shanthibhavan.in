...
"[project]/models/Payment.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
;
const VolunteerSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["Schema"]({
    name: {
        type: String,
        required: true
    },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Payment.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Volunteer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Volunteer.ts [app-route] (ecmascript)");
...
async function GET() {
    try {
        ...
        const totalPayments = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const completedPayments = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            status: 'completed'
        });
        const paymentAggregation = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    status: 'completed'
                }
        ...
        const totalVolunteers = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Volunteer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const totalContacts = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Contact$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        // Get recent payments (last 30 days)
        const thirtyDaysAgo = new Date();
        thirtyDaysAgo.setDate(thirtyDaysAgo.getDate() - 30);
        const recentPayments = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            createdAt: {
                $gte: thirtyDaysAgo
            },
            status: 'completed'
        ...
        const monthlyTrend = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Payment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    status: 'completed',
                    createdAt: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c0334b7._.js.map