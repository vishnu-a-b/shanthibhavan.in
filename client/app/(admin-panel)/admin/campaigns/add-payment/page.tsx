...
export default function AddCampaignPaymentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccess(true);
        setTimeout(() => router.push('/admin/donations?type=campaign'), 2000);
      } else {
    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Payment Added!</h2>
          <p className="text-gray-600">The offline campaign payment has been submitted for approval.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-8">
      <Link href="/admin/campaigns" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6">
      ...
      <div className="max-w-2xl">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Add Campaign Payment</h1>
            <p className="text-gray-600">Record an offline payment for a campaign</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="col-span-2">
              ...
              {campaigns.length === 0 && (
                <p className="text-xs text-amber-600 mt-1">No active campaigns found. Activate a campaign first.</p>
              )}
            </div>
